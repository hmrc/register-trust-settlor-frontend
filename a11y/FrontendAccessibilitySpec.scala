...
import views.html.deceased_settlor.mld5.{
  CountryOfNationalityView => DeceasedCountryOfNationalityView,
  CountryOfResidenceInTheUkYesNoView => DeceasedCountryOfResidenceInTheUkYesNoView,
  CountryOfResidenceView => DeceasedCountryOfResidenceView,
  CountryOfResidenceYesNoView => DeceasedCountryOfResidenceYesNoView,
  _
}
import views.html.errors._
import views.html.living_settlor._
import views.html.living_settlor.business._
import views.html.living_settlor.business.mld5.{
  CountryOfResidenceInTheUkYesNoView => BusinessCountryOfResidenceInTheUkYesNoView,
  CountryOfResidenceView => BusinessCountryOfResidenceView,
  CountryOfResidenceYesNoView => BusinessCountryOfResidenceYesNoView
}
import views.html.living_settlor.individual._
import views.html.living_settlor.individual.mld5.{
  CountryOfNationalityView => IndividualCountryOfNationalityView,
  CountryOfNationalityYesNoView => IndividualCountryOfNationalityYesNoView,
  _
}
...
class FrontendAccessibilitySpec extends AutomaticAccessibilitySpec {
  ...
  implicit val arbAddASettlorForm: Arbitrary[Form[_]]         = fixed(app.injector.instanceOf[AddASettlorFormProvider].apply())
