...
import pages.living_settlor.business.{SettlorBusinessAddressUKYesNoPage, SettlorBusinessNamePage}
import play.api.mvc.Call
import play.api.test.FakeRequest
import play.api.test.Helpers._
import views.html.living_settlor.business.SettlorBusinessAddressUKYesNoView

class SettlorBusinessAddressUKYesNoControllerSpec extends SpecBase {
  ...
  lazy val settlorBusinessAddressUKYesNoRoute = routes.SettlorBusinessAddressUKYesNoController.onPageLoad(NormalMode, index, fakeDraftId).url
  ...
  "SettlorBusinessAddressUKYesNo Controller" must {
    ...
    "return OK and the correct view for a GET" in {
      ...
      val request = FakeRequest(GET, settlorBusinessAddressUKYesNoRoute)

      val result = route(application, request).value

      val view = application.injector.instanceOf[SettlorBusinessAddressUKYesNoView]
    ...
    "redirect to the next page when valid data is submitted" in {
      ...
      val request =
        FakeRequest(POST, settlorBusinessAddressUKYesNoRoute)
