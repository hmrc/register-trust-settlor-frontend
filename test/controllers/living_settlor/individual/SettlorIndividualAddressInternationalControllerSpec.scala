...
class SettlorIndividualAddressInternationalControllerSpec extends SpecBase {
  ...
  private lazy val settlorIndividualAddressInternationalRoute: String =
    routes.SettlorIndividualAddressInternationalController.onPageLoad(index, fakeDraftId).url
  ...
  "SettlorIndividualAddressInternational Controller" must {
    ...
    "return OK and the correct view for a GET" in {
      ...
      val view: SettlorIndividualAddressInternationalView =
        application.injector.instanceOf[SettlorIndividualAddressInternationalView]
      ...
      contentAsString(result) mustEqual
        view(form, countryOptions, index, fakeDraftId, name, settlorAliveAtRegistration = false)(
          request,
          messages
        ).toString
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      ...
      contentAsString(result) mustEqual
        view(
          ...
          fakeDraftId,
          name,
          settlorAliveAtRegistration = true
    ...
    "return a Bad Request and errors when invalid data is submitted" in {
      ...
      contentAsString(result) mustEqual
        view(boundForm, countryOptions, index, fakeDraftId, name, settlorAliveAtRegistration = true)(
          request,
          messages
        ).toString
