...
class CountryOfResidencyYesNoControllerSpec extends SpecBase {
  ...
  private lazy val onPageLoadRoute: String = routes.CountryOfResidencyYesNoController.onPageLoad(NormalMode, index, fakeDraftId).url
  ...
  "CountryOfResidencyYesNo Controller" must {
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = baseAnswers
        .set(CountryOfResidencyYesNoPage(index), validAnswer).success.value
