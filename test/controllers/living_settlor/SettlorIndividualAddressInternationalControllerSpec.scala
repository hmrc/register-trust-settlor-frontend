...
import pages.living_settlor.{SettlorAddressInternationalPage, SettlorIndividualNINOPage, SettlorIndividualNamePage}
...
class SettlorIndividualAddressInternationalControllerSpec extends SpecBase {
  ...
  lazy val settlorIndividualAddressInternationalRoute: String = routes.SettlorIndividualAddressInternationalController.onPageLoad(NormalMode, index, fakeDraftId).url
