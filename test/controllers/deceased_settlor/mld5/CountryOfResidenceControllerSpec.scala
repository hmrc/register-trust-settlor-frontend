...
class CountryOfResidenceControllerSpec extends SpecBase {
  ...
  lazy val countryOfResidenceRoute = CountryOfResidenceController.onPageLoad(fakeDraftId).url
  ...
  "CountryOfResidence Controller" must {
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers =
        emptyUserAnswers.set(CountryOfResidencePage, "Spain").success.value.set(SettlorsNamePage, name).success.value
