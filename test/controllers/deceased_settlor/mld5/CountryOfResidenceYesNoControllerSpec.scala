...
class CountryOfResidenceYesNoControllerSpec extends SpecBase {
  ...
  lazy val countryOfResidenceYesNoRoute = CountryOfResidenceYesNoController.onPageLoad(fakeDraftId).url
  ...
  "CountryOfResidenceYesNoController Controller" must {
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers =
        emptyUserAnswers.set(CountryOfResidenceYesNoPage, true).success.value.set(SettlorsNamePage, name).success.value
