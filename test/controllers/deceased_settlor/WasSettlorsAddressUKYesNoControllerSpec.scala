...
class WasSettlorsAddressUKYesNoControllerSpec extends SpecBase {
  ...
  "WasSettlorsAddressUKYesNo Controller" must {
    ...
    "return OK and the correct view for a GET" in {
      ...
      val request = FakeRequest(GET, wasSettlorsAddressUKYesNoRoute)

      val result = route(application, request).value

      val view = application.injector.instanceOf[WasSettlorsAddressUKYesNoView]
