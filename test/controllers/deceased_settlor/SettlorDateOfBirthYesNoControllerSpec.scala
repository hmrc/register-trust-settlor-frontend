...
class SettlorDateOfBirthYesNoControllerSpec extends SpecBase {
  ...
  lazy val settlorDateOfBirthYesNoRoute = routes.SettlorDateOfBirthYesNoController.onPageLoad(fakeDraftId).url
  ...
  "SettlorDateOfBirthYesNo Controller" must {
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers =
        emptyUserAnswers.set(SettlorDateOfBirthYesNoPage, true).success.value.set(SettlorsNamePage, name).success.value
