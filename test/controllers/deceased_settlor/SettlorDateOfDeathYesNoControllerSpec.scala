...
class SettlorDateOfDeathYesNoControllerSpec extends SpecBase {
  ...
  lazy val settlorDateOfDeathYesNoRoute = routes.SettlorDateOfDeathYesNoController.onPageLoad(fakeDraftId).url

  val name = FullName("first name", None, "Last name")

  "SettlorDateOfDeathYesNo Controller" must {
    ...
    "return OK and the correct view for a GET" in {
      ...
      val request = FakeRequest(GET, settlorDateOfDeathYesNoRoute)

      val result = route(application, request).value

      val view = application.injector.instanceOf[SettlorDateOfDeathYesNoView]
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = emptyUserAnswers.set(SettlorDateOfDeathYesNoPage, true).success.value.set(SettlorsNamePage,name).success.value
