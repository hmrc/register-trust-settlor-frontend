...
class WasSettlorsAddressUKYesNoViewSpec extends YesNoViewBehaviours {
  ...
  val messageKeyPrefix = "wasSettlorsAddressUKYesNo"

  val form = new YesNoFormProvider().withPrefix("wasSettlorsAddressUKYesNo")

  "WasSettlorsAddressUKYesNo view" must {

    val name = FullName("First", None, "Last")

    val view = viewFor[WasSettlorsAddressUKYesNoView](Some(emptyUserAnswers))
