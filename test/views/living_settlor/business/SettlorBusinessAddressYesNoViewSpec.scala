...
class SettlorBusinessAddressYesNoViewSpec extends YesNoViewBehaviours {

  val messageKeyPrefix = "settlorBusinessAddressYesNo"
  val index = 0
  val name = "Business name"

  val form = new YesNoFormProvider().withPrefix(messageKeyPrefix)

  "SettlorBusinessAddressYesNo view" must {

    val view = viewFor[SettlorBusinessAddressYesNoView](Some(emptyUserAnswers))
