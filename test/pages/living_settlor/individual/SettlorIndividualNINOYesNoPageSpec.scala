      ...
      "set to true" in
        forAll(arbitrary[UserAnswers]) { initial =>
          val answers: UserAnswers = initial
            ...
            .success
            .value
            .set(SettlorAddressYesNoPage(0), true)
            .success
            .value
            .set(SettlorAddressUKYesNoPage(0), true)
            .success
            .value
            .set(SettlorAddressUKPage(0), UKAddress("", "", None, None, ""))
            .success
            .value
            .set(SettlorAddressInternationalPage(0), InternationalAddress("", "", None, ""))
            .success
            .value
            .set(SettlorIndividualPassportYesNoPage(0), true)
            .success
            .value
            .set(SettlorIndividualPassportPage(0), PassportOrIdCardDetails("", "", LocalDate.now()))
            .success
            .value
            .set(SettlorIndividualIDCardYesNoPage(0), true)
            .success
            .value
            .set(SettlorIndividualIDCardPage(0), PassportOrIdCardDetails("", "", LocalDate.now()))
            .success
            .value
      ...
      "set to false" in
        forAll(arbitrary[UserAnswers]) { initial =>
          val answers: UserAnswers = initial
            ...
            .success
            .value
            .set(SettlorIndividualNINOPage(0), "QQ123456C")
            .success
            .value
