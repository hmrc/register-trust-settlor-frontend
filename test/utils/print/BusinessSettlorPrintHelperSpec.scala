...
class BusinessSettlorPrintHelperSpec extends SpecBase with ScalaCheckPropertyChecks with BeforeAndAfterEach {
    ...
    "return a business settlor answer section" when {
      ...
      "no UTR, country of residence or address" in {
        ...
        val expectedAnswerRows = Seq(
          AnswerRow(
            ...
            labelArg = businessName
          ),
          AnswerRow(
            label = "settlorBusinessName.checkYourAnswersLabel",
            answer = Html("Business Ltd."),
            changeUrl = Some(SettlorBusinessNameController.onPageLoad(index, fakeDraftId).url),
            labelArg = businessName
          ),
          AnswerRow(
            label = "settlorBusinessUtrYesNo.checkYourAnswersLabel",
            answer = Html("No"),
            changeUrl = Some(SettlorBusinessUtrYesNoController.onPageLoad(index, fakeDraftId).url),
            labelArg = businessName
          ),
          AnswerRow(
            label = "settlorBusiness.5mld.countryOfResidenceYesNo.checkYourAnswersLabel",
            answer = Html("No"),
            changeUrl = Some(CountryOfResidenceYesNoController.onPageLoad(index, fakeDraftId).url),
            labelArg = businessName
          ),
          AnswerRow(
            label = "settlorBusinessAddressYesNo.checkYourAnswersLabel",
            answer = Html("No"),
            changeUrl = Some(SettlorBusinessAddressYesNoController.onPageLoad(index, fakeDraftId).url),
            labelArg = businessName
          )
        )
      ...
      "UTR and no country of residence with business type and business time" in {
        ...
        val expectedAnswerRows = Seq(
          ...
          AnswerRow(
            label = "settlorBusinessUtr.checkYourAnswersLabel",
            answer = Html("1234567890"),
            changeUrl = Some(SettlorBusinessUtrController.onPageLoad(index, fakeDraftId).url),
            labelArg = businessName
          ),
          AnswerRow(
            label = "settlorBusiness.5mld.countryOfResidenceYesNo.checkYourAnswersLabel",
          ...
          AnswerRow(
            label = "settlorBusinessType.checkYourAnswersLabel",
            answer = Html("Investment"),
            changeUrl = Some(SettlorBusinessTypeController.onPageLoad(index, fakeDraftId).url),
            labelArg = businessName
          ),
          AnswerRow(
            label = "settlorBusinessTimeYesNo.checkYourAnswersLabel",
            answer = Html("Yes"),
            changeUrl = Some(SettlorBusinessTimeYesNoController.onPageLoad(index, fakeDraftId).url),
            labelArg = businessName
          )
        )
      ...
      "address and country of residence" when {
        ...
        "UK" in {
          ...
          val expectedAnswerRows = Seq(
            ...
            AnswerRow(
              label = "settlorBusiness.5mld.countryOfResidenceInTheUkYesNo.checkYourAnswersLabel",
              answer = Html("Yes"),
              changeUrl = Some(CountryOfResidenceInTheUkYesNoController.onPageLoad(index, fakeDraftId).url),
              labelArg = businessName
            ),
            AnswerRow(
              label = "settlorBusinessAddressYesNo.checkYourAnswersLabel",
            ...
            AnswerRow(
              label = "settlorBusinessAddressUKYesNo.checkYourAnswersLabel",
              answer = Html("Yes"),
              changeUrl = Some(SettlorBusinessAddressUKYesNoController.onPageLoad(index, fakeDraftId).url),
              labelArg = businessName
            ),
            AnswerRow(
              label = "settlorBusinessAddressUK.checkYourAnswersLabel",
              answer = Html("Line 1<br />Line 2<br />Line 3<br />Line 4<br />AB11AB"),
              changeUrl = Some(SettlorBusinessAddressUKController.onPageLoad(index, fakeDraftId).url),
              labelArg = businessName
            )
          )
        ...
        "international" in {
          ...
          val expectedAnswerRows = Seq(
            ...
            AnswerRow(
              label = "settlorBusiness.5mld.countryOfResidence.checkYourAnswersLabel",
              answer = Html("France"),
              changeUrl = Some(CountryOfResidenceController.onPageLoad(index, fakeDraftId).url),
              labelArg = businessName
            ),
            AnswerRow(
              label = "settlorBusinessAddressYesNo.checkYourAnswersLabel",
            ...
            AnswerRow(
              label = "settlorBusinessAddressInternational.checkYourAnswersLabel",
              answer = Html("Line 1<br />Line 2<br />Line 3<br />France"),
              changeUrl = Some(SettlorBusinessAddressInternationalController.onPageLoad(index, fakeDraftId).url),
              labelArg = businessName
            )
          )
  ...
  private def assertThatUserAnswersProduceExpectedAnswerRows(
    ...
    val checkDetailsSection =
      businessSettlorPrintHelper.checkDetailsSection(userAnswers, businessName, fakeDraftId, index)
    ...
    forAll(arbitrary[Int].suchThat(_ > 0)) { subsequentIndex =>
      val subsequentPrintSection =
        businessSettlorPrintHelper.printSection(userAnswers, businessName, fakeDraftId, subsequentIndex)
