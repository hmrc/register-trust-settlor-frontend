    ...
    "map user answers to individual settlor model" when {
      ...
      "one settlor" when {
        ...
        "UK address and passport" in {
          ...
          val userAnswers: UserAnswers = emptyUserAnswers
            ...
            .success
            .value
            .set(SettlorIndividualPassportPage(index), passportOrIdCard)
            .success
            .value
        ...
        "non-UK address and ID card" in {
          ...
          val userAnswers: UserAnswers = emptyUserAnswers
            ...
            .success
            .value
            .set(SettlorIndividualIDCardPage(index), passportOrIdCard)
            .success
            .value
      ...
      "more than one settlor" in {
        ...
        val userAnswers: UserAnswers = emptyUserAnswers
          ...
          .success
          .value
          .set(SettlorIndividualNamePage(0), name(0))
          .success
          .value
          .set(SettlorIndividualDateOfBirthYesNoPage(0), false)
          .success
          .value
          .set(SettlorIndividualNINOYesNoPage(0), false)
          .success
          .value
          .set(SettlorAddressYesNoPage(0), false)
          .success
          .value
          .set(SettlorAliveYesNoPage(1), true)
          .success
          .value
          .set(SettlorIndividualNamePage(1), name(1))
          .success
          .value
          .set(SettlorIndividualDateOfBirthYesNoPage(1), false)
          .success
          .value
          .set(SettlorIndividualNINOYesNoPage(1), false)
          .success
          .value
          .set(SettlorAddressYesNoPage(1), false)
          .success
          .value
      ...
      "non-UK country of nationality and residency" in {
        ...
        val userAnswers: UserAnswers = emptyUserAnswers
          ...
          .success
          .value
          .set(CountryOfResidencyPage(index), "ES")
          .success
          .value
          .set(SettlorAddressYesNoPage(index), false)
          .success
