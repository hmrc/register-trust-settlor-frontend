...
class LivingSettlorNavigator @Inject()(config: FrontendAppConfig) extends Navigator(config) {
  ...
  override protected def route(draftId: String): PartialFunction[Page, AffinityGroup => UserAnswers => Call] = {
    ...
    case SettlorIndividualNamePage(index) => _ => _ => controllers.living_settlor.individual.routes.SettlorIndividualDateOfBirthYesNoController.onPageLoad(NormalMode, index, draftId)
    ...
    case SettlorIndividualDateOfBirthPage(index) => _ => _ => controllers.living_settlor.individual.routes.SettlorIndividualNINOYesNoController.onPageLoad(NormalMode, index, draftId)
    ...
    case SettlorIndividualNINOPage(index) => _ => _ => controllers.living_settlor.individual.routes.SettlorIndividualAnswerController.onPageLoad(index, draftId)
    ...
    case SettlorAddressUKPage(index) => _ => _ => controllers.living_settlor.individual.routes.SettlorIndividualPassportYesNoController.onPageLoad(NormalMode, index, draftId)
    case SettlorAddressInternationalPage(index) => _ => _ => controllers.living_settlor.individual.routes.SettlorIndividualPassportYesNoController.onPageLoad(NormalMode, index, draftId)
    ...
    case SettlorIndividualPassportPage(index) => _ => _ => controllers.living_settlor.individual.routes.SettlorIndividualAnswerController.onPageLoad(index, draftId)
    case SettlorIndividualIDCardYesNoPage(index)  => _ => yesNoNav(SettlorIndividualIDCardYesNoPage(index),
      ...
      noCall = controllers.living_settlor.individual.routes.SettlorIndividualAnswerController.onPageLoad(index, draftId))
    case SettlorIndividualIDCardPage(index) => _ => _ => controllers.living_settlor.individual.routes.SettlorIndividualAnswerController.onPageLoad(index, draftId)
