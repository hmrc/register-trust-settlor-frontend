...
import pages.living_settlor.{SettlorIndividualNINOYesNoPage, SettlorIndividualNamePage}
...
class SettlorIndividualNINOYesNoController @Inject()(
  ...
  val form: Form[Boolean] = yesNoFormProvider.withPrefix("settlorIndividualNINOYesNo")
