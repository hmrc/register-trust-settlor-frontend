...
import pages.living_settlor.{SettlorAddressUKYesNoPage, SettlorIndividualNamePage}
import play.api.data.Form
import play.api.i18n.{I18nSupport, MessagesApi}
import play.api.mvc.{Action, AnyContent, MessagesControllerComponents}
import repositories.RegistrationsRepository
import uk.gov.hmrc.play.bootstrap.controller.FrontendBaseController
import views.html.living_settlor.SettlorIndividualAddressUKYesNoView
...
class SettlorIndividualAddressUKYesNoController @Inject()(
  ...
  val form: Form[Boolean] = yesNoFormProvider.withPrefix("settlorIndividualAddressUKYesNo")
